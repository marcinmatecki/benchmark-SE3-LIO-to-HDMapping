...
RUN sed -i 's|/os_cloud_node/imu|/livox/imu|g' src/se3-lio/ros/ros1/config/ncd.yaml \
 && sed -i 's|/os_cloud_node/points|/livox/pointcloud|g' src/se3-lio/ros/ros1/config/ncd.yaml
